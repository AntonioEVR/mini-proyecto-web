...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary px-4 shadow-sm">
    ...
    <div class="ms-auto">
        <a href="../vistas/inicio_sesion_V.php" class="btn btn-outline-light me-2 btn-sm">Iniciar sesión</a>
        <a href="../vistas/registro_V.php" class="btn btn-light btn-sm">Registrarse</a>
    </div>
</nav>
